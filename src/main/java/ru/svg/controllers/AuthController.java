    ...
    public ResponseEntity<?> register(@RequestBody User newUser) {
        ...
        if (newUser.getLogin() != null && newUser.getPassword() != null) {
            ...
            if (userService.findUserByLogin(newUser.getLogin()) == null) {
                ...
                log.info("User with login \"{}\" is registered", newUser.getLogin());
                ...
                log.warn("User with login \"{}\" isn't registered. Duplicate username.", newUser.getLogin());
